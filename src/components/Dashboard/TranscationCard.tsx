...
import { Edit, Trash2, TrendingUp, TrendingDown, Filter, Search, Calendar, Tag } from 'lucide-react';
...
const TransactionList: React.FC<TransactionListProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {processedTransactions.length === 0 && (searchTerm || filterType !== 'all' || filterPayment !== 'all') && (
